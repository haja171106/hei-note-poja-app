package com.haja.school.endpoint.event.consumer;

import com.haja.school.PojaGenerated;
import com.haja.school.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.haja.school.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.haja.school.service.event."
